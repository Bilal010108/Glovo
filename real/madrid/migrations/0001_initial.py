    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products_orders', to='madrid.product')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImage',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='madrid.product')),
            ],
        ),
        migrations.CreateModel(
            name='Store',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='store_reviews', to='madrid.store')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='store',
            field=models.ManyToManyField(related_name='store_product', to='madrid.store'),
        ),
    ]
